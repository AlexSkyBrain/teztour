...
<section class="actual-offer">
  <div class="container">
    ...
    <div class="actual-offer__wrap actual-offer__wrap_sl">
      <a href="#" class="offer">
        <img src="<?php echo get_template_directory_uri() ?>/images/offer1.jpg" alt="Отдых">
        <div class="offer__overlay">
          Лучшие цены <br> от TEZ TOUR
        </div>
      </a>
      <a href="#" class="offer">
        <img src="<?php echo get_template_directory_uri() ?>/images/offer2.jpg" alt="Отдых">
        <div class="offer__overlay">
          Новогодние туры
        </div>
      </a>
      ...
      <a href="#" class="offer">
        <img src="<?php echo get_template_directory_uri() ?>/images/offer3.jpg" alt="Отдых">
        <div class="offer__overlay">
          Свадебные туры
        </div>
      </a>
      <a href="#" class="offer">
        <img src="<?php echo get_template_directory_uri() ?>/images/offer4.jpg" alt="Отдых">
        <div class="offer__overlay">
         VIP отдых и услуги
        </div>
      </a>
      <a href="#" class="offer">
        <img src="<?php echo get_template_directory_uri() ?>/images/offer5.jpg" alt="Отдых">
        <div class="offer__overlay">
         Отдых на островах
        </div>
      </a>
      <a href="#" class="offer">
        <img src="<?php echo get_template_directory_uri() ?>/images/offer6.jpg" alt="Отдых">
        <div class="offer__overlay">
         Морские круизы
        </div>
      </a>
      <a href="#" class="offer">
        <img src="<?php echo get_template_directory_uri() ?>/images/offer7.jpg" alt="Отдых">
        <div class="offer__overlay">
         Детский отдых
        </div>
      </a>
